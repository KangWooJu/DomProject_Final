...
public class AuctionMyPageController {
    ...
    @GetMapping("/{id}")
    public String mypage(Model model,@PathVariable("id") Integer id,AuctionRegisterForm auctionRegisterForm,@RequestParam(value="page", defaultValue="0") int page,Principal principal) {
        ...
        Page<AuctionRegisterEntity> pagingMine = this.auctionRegisterService.getListMine(id,page,10); // 자신이 등록한 거래글을 보여주는 page객체 : 7/22 username을 id로 수정
    ...
    public String userModify(SiteuserCreateForm siteuserCreateForm,@PathVariable("id") Integer id,Principal principal){
    ...
    public String userModify(@Valid SiteuserCreateForm siteuserCreateForm,BindingResult bindingResult,Principal principal,@PathVariable("id") Integer id){
        ...
        return String.format("redirect:/mypage/%s",id); // siteuserService의 modify 메소드 사용 -> 서비스 파일 참고 
    }
